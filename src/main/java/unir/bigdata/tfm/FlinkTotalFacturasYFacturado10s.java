...
public class FlinkTotalFacturasYFacturado10s extends FlinkBase implements Serializable {

    String nombreDeArchivo;

    public FlinkTotalFacturasYFacturado10s() {
        nombreDeArchivo  = "/home/guillermo/Documents/salidas/FlinkTotalFacturasYFacturado10s_" +
    ...
    public static void main(String[] args) throws Exception {
        ...
        FlinkTotalFacturasYFacturado10s totalFacturasYFacturado = new FlinkTotalFacturasYFacturado10s();
        totalFacturasYFacturado.ejecutar();
    }
}
