...
public class SparkTotalFacturas10s extends SparkBase implements Serializable {

    String nombreDeArhivo;

    public SparkTotalFacturas10s(int duracionVentana) {
        super(duracionVentana);
        nombreDeArhivo = "/home/guillermo/Documents/salidas/SparkTotalFacturas10s_" + System.currentTimeMillis() +".txt";
    }
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        SparkTotalFacturas10s sparkTotalFacturas10s = new SparkTotalFacturas10s(10);
