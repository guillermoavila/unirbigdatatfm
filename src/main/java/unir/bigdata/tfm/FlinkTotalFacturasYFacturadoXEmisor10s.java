...
public class FlinkTotalFacturasYFacturadoXEmisor10s extends FlinkBase implements Serializable {

    String nombreDeArchivo;

    public FlinkTotalFacturasYFacturadoXEmisor10s() {
        nombreDeArchivo =  "/home/guillermo/Documents/salidas/FlinkTotalFacturasYFacturadoXEmisor10s_" + System.currentTimeMillis() + ".txt";
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        FlinkTotalFacturasYFacturadoXEmisor10s flinkTotalFacturasYFacturadoXEmisor10s = new FlinkTotalFacturasYFacturadoXEmisor10s();
        flinkTotalFacturasYFacturadoXEmisor10s.ejecutar();
    }
}
